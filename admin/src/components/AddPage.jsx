...
// this function will convert (YYYY-MM-DD) to Data Month year
...
export const AddPage = () => {
  ...
  //   it will show a toast for 3 src
  useEffect(() => {
...
//           <input
//             className={s.inputBase}
//             placeholder="Qualifications (e.g. MBBS)"
//             value={form.qualifications}
//             onChange={(e) =>
//               setForm({ ...form, qualifications: e.target.value })
//             }
...
//                       if (
//                         window.confirm(
//                           `Remove slot: ${formatDateISO(date)} — ${time}?`,
//                         )
//                       ) {
